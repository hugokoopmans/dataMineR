...
\definecolor{dikwgreen}{rgb}{.0,.5,.0}
\makeatletter
...
\resizebox{!}{#1}{\fboxsep=1pt%
    \colorbox{dikwgreen}{\color{white}\bfseries\sffamily\thechapter}%
}}%
\rotatebox{90}{%
\resizebox{%
...
\renewcommand\chaptitlefont{\normalfont\huge\bfseries\scshape\color{dikwgreen}}
...
\lfoot{\textsc{DIKW Consulting}}\cfoot{dataMineR}\rfoot{\thepage}
